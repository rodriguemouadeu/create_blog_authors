...
public class UserDAO {
    ...
    public boolean addUser(String username, String password, String email) {
        ...
        Document userDoc = new Document("_id", username).append("username", username).append("password", passwordHash);

        if (email != null && !email.equals("")) {
            // XXX WORK HERE
            // if there is an email address specified, add it to the document too.
            userDoc = new Document("_id", username).append("username", username).append("password", passwordHash).append("email", email);
        }
